            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="relative">
                ...
                <input
                  type="search"
                  placeholder="Type to search"
                  className="px-4 py-2 pl-10 rounded border focus:outline-none focus:border-[#C38154] bg-white"
                />
              </div>
            </div>
              ...
              <table className="min-w-full border">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 border">Nama</th>
                    <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 border">Kategori</th>
                    <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 border">Harga</th>
                    <th className="px-6 py-3 text-left text-sm font-medium text-gray-900 border">Aksi</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {products.map((product) => (
                    <tr key={product.id}>
                      <td className="px-6 py-2 text-gray-900 border">{product.name}</td>
                      <td className="px-6 py-2 text-gray-900 border">{activeCategory}</td>
                      <td className="px-6 py-2 text-gray-900 border">Rp. {product.price.toLocaleString()}</td>
                      <td className="px-6 py-2 border">
                        <div className="flex gap-2">
                          <button className="bg-[#2536EB] text-white px-3 py-1 rounded flex items-center gap-1">
