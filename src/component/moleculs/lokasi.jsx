...
const LokasiWarungKopi = () => {
    const handleButtonClick = () => {
        // Ganti dengan link lokasi Google Maps Anda
        window.open('https://www.google.com/maps?q=lokasi+warung+kopi', '_blank');
    };

    return (
        <div className="flex flex-col md:flex-row justify-evenly p-8 bg-primary shadow-md">
            {/* Konten sebelah kiri */}
            <div className="flex flex-col justify-center text-center mb-4 md:mb-0">
                ...
                <p className="font-bright text-secondary text-lg text-gray-600 mb-4">dan rasakan kenangan di setiap sudutnya</p>
                <ButtonLocation />
            </div>
