  ...
  return (
    <div className="mt-1">
      <a
        ...
        className="font-display font-semibold inline-flex items-center justify-evenly gap-8 px-8 py-3 w-[290px] md:w-[300px] bg-primary text-secondary text-sm rounded-full shadow-md hover:bg-third hover:text-white transition duration-300"
      >
        OTW Sekarang Juga
