  ...
  return (
    <div className="mt-1">
      <a
        ...
        className="inline-flex items-center gap-5 px-4 py-1 bg-third text-kuning font-display font-thin text-sm border border-kuning rounded-full shadow-md hover:bg-primary transition duration-300"
      >
        OTW Sekarang Juga
